...
export const SparkleIcon = (props) => (
    <svg
        ...
        {...props}
    >
        <path fillRule="evenodd" d="M10.868 2.884c.321-.772 1.308-.772 1.629 0l1.314 3.174a.69.69 0 00.523.523l3.174 1.314c.772.321.772 1.308 0 1.629l-3.174 1.314a.69.69 0 00-.523.523l-1.314 3.174c-.321.772-1.308.772-1.629 0l-1.314-3.174a.69.69 0 00-.523-.523l-3.174-1.314c-.772-.321-.772-1.308 0-1.629l3.174-1.314a.69.69 0 00.523-.523z" clipRule="evenodd" />
    </svg>
);